...
import com.knowledgespike.db.routines.TeamBowlingRecordsByGroundOverallEx
...
import com.knowledgespike.db.routines.TeamRecordsByGroundOverallEx
...
/**
 * Call <code>cricketarchive.team_bowling_records_by_ground_overall_ex</code>
 */
fun teamBowlingRecordsByGroundOverallEx(
      configuration: Configuration
    , matchType: String?
    , matchSubtype: String?
    , teamId: Int?
    ...
    val p = TeamBowlingRecordsByGroundOverallEx()
    p.setMatchType(matchType)
    p.setMatchSubtype(matchSubtype)
    p.setTeamId(teamId)
    p.setOpponentsId(opponentsId)
...
/**
 * Call <code>cricketarchive.team_records_by_ground_overall_ex</code>
 */
fun teamRecordsByGroundOverallEx(
      configuration: Configuration
    , matchType: String?
    , matchSubtype: String?
    , teamId: Int?
    ...
    val p = TeamRecordsByGroundOverallEx()
    p.setMatchType(matchType)
    p.setMatchSubtype(matchSubtype)
    p.setTeamId(teamId)
    p.setOpponentsId(opponentsId)
